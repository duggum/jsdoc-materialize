...
function hashToLink(doclet, hash) {
  ...
  return '<a href="' + url + '" title="' + hash + '">' + hash + '</a>';
}
...
// console.error(packages);
  ...
  if (opts.mdPages.length) {
    opts.mdPages.forEach(function(element) {
      var parse = markdown.getParser();
      var html = parse(fs.readFileSync(element, opts.encoding));
      var name = path.basename(element, ".md");
      var title = toTitleCase(name);
      var url = helper.getUniqueFilename(name);
